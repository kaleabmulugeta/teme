...
const designs = [
  {
    ...
    images: [
      "/photos/konjit.webp",
      "/photos/konjit-2.webp",
      "/photos/konjit-3.webp",
      "/photos/konjit-4.webp",
      "/photos/konjit-5.webp",
      "/photos/konjit-6.webp",
      "/photos/konjit-7.webp",
    ],
  },
  {
    id: 2,
    ...
    images: [
      "/photos/anbesaw.webp",
      "/photos/anbesaw-2.webp",
      "/photos/anbesaw-3.webp",
      "/photos/anbesaw-4.webp",
      "/photos/anbesaw-5.webp",
      "/photos/anbesaw-6.webp",
      "/photos/anbesaw-7.webp",
    ],
  },
  {
    id: 3,
...
export default function Gallery() {
  ...
  const getDesignImages = (design: (typeof designs)[number]) =>
    design.images ?? [design.image];
  ...
  return (
    <Section
      id="gallery"
      className={`min-h-screen ${isDark ? "bg-neutral-950 text-white" : "bg-white text-black"}`}
    >
      <div className="max-w-7xl mx-auto" lang={language}>
        <div className="text-center mb-16">
          <h2
            className={`text-4xl md:text-6xl font-bold tracking-tighter mb-4 ${isDark ? "text-white/90" : "text-black/90"}`}
          >
            {t("gallery.title1")}{" "}
          ...
          <p
            className={`${isDark ? "text-neutral-400" : "text-neutral-600"} opacity-80`}
          >
            {t("gallery.subtitle")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {designs.map((design, idx) => (
            <motion.div
              ...
              aria-label={
                language === "am"
                  ? `${design.nameAm} ዲዛይን ይመልከቱ`
                  : `View ${design.name} design`
              }
              onClick={() => {
            ...
            >
              ...
              <div className="absolute inset-0 p-4 flex flex-col justify-between z-10">
                ...
                <div className="flex justify-end">
                  <span
                    className={`text-[10px] font-medium uppercase tracking-wider px-2 py-1 rounded-full border ${isDark ? "text-neutral-400 bg-black/40 border-white/10" : "text-neutral-600 bg-white border-black/10"}`}
                  >
            ...
            >
              ...
              >
                ...
                >
                  <div>
                    <p
                      className={`text-xs uppercase tracking-[0.3em] ${isDark ? "text-neutral-500" : "text-neutral-400"}`}
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-6 p-6">
                  <div className="space-y-4">
                    <div className="relative overflow-hidden rounded-xl border border-black/10 bg-black/5 w-[600px] h-[380px] max-w-full">
                      ...
                      <button
                        ...
                        aria-label={
                          language === "am" ? "ቀደም ያለ ምስል" : "Previous image"
                        }
                      >
                      ...
                      <button
                        ...
                        aria-label={
                          language === "am" ? "ቀጣይ ምስል" : "Next image"
                        }
                      >
                  ...
                  <div className="space-y-6">
                    <div>
                      <p
                        className={`text-sm uppercase tracking-wider ${isDark ? "text-neutral-500" : "text-neutral-400"}`}
                      >
                    ...
                    >
                      <MessageCircle
                        className={
                          language === "en" ? "w-4 h-4" : "w-[18px] h-[18px]"
                        }
                      />
                      {language === "am"
                        ? "ስለዚህ ዲዛይን ይጠይቁ"
