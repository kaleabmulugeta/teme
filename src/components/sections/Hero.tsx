  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className={`hero-text text-lg md:text-xl max-w-2xl font-light tracking-wide subpixel-antialiased ${isDark ? "text-neutral-200 drop-shadow-[0_4px_14px_rgba(0,0,0,0.7)]" : "text-neutral-900 drop-shadow-[0_1px_2px_rgba(0,0,0,0.25)]"} ${language === "am" ? "leading-relaxed" : ""}`}
        >
          {t("hero.subtitle")}
        </p>
