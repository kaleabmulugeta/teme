    ...
    <>
      ...
      >
        <div className="max-w-3xl mx-auto text-center" lang={language}>
          ...
          <p
            className={`mb-12 ${isDark ? "text-neutral-400" : "text-neutral-600"}`}
          >
            {t("contact.subtitle")}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label
                  htmlFor="name"
                  className={`text-sm font-medium uppercase tracking-wider ${isDark ? "text-neutral-500" : "text-neutral-600"}`}
                >
                  {t("contact.name")}
                </label>
                <input
            ...
            <div className="space-y-2">
              ...
              >
                <option value="automotive">
                  {t("contact.interest.automotive")}
                </option>
                <option value="architectural">
                  {t("contact.interest.architectural")}
                </option>
                <option value="aviation">
                  {t("contact.interest.aviation")}
                </option>
            ...
            <div className="text-center pt-8">
              ...
              <p
                className={`text-xs mt-4 ${isDark ? "text-neutral-600" : "text-neutral-500"}`}
              >
                {language === "en"
